...
function UserProfile() {
  const { loginname, setloginname, setCart, setToken, themeMode } = useContext(Contextapi);
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_API_URL}/${loginname}`, {
      method: "GET",
      headers: {
  ...
  const confirmUpdate = () => window.confirm("Are you sure you want to update these fields?");
